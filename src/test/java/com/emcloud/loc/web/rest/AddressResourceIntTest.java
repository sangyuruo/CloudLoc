...
public class AddressResourceIntTest {
    ...
    public void createAddress() throws Exception {
        ...
        assertThat(testAddress.getAddressName()).isEqualTo(DEFAULT_ADDRESS_NAME);
        assertThat(testAddress.getAddressCode()).isEqualTo(DEFAULT_ADDRESS_CODE);
        ...
        assertThat(testAddress.getUpdateTime()).isEqualTo(DEFAULT_UPDATE_TIME);
    }
    ...
    public void updateAddress() throws Exception {
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getAddressName()).isEqualTo(UPDATED_ADDRESS_NAME);
        assertThat(testAddress.getAddressCode()).isEqualTo(UPDATED_ADDRESS_CODE);
        ...
        assertThat(testAddress.getUpdateTime()).isEqualTo(UPDATED_UPDATE_TIME);
    }
