...
class AddressGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("EmCloudLocapp:my-secret-token-to-change-in-production".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Address entity")
        ...
        .formParam("client_id", "EmCloudLocapp")
        ...
        .repeat(2) {
            ...
            .repeat(5) {
                ...
                .get("/emcloudloc${new_address_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created address")
            .delete("/emcloudloc${new_address_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
